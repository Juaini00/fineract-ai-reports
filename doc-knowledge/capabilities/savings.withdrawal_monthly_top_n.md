...
resource: ../../knowledge/capabilities/savings/withdrawal_monthly_top_n.yaml
tags: [savings, monthly_top_n, approved_mvp]
---

# Summary

- **Runtime id:** `savings_withdrawal_monthly_top_n` (status `approved_mvp`)
- **Query:** [savings.withdrawal_monthly_top_n](../queries/savings.withdrawal_monthly_top_n.md) → `queries/savings/withdrawal_monthly_top_n.sql`
