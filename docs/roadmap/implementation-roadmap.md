...
The old monolithic `implementation-steps.md` was split into focused phase files under [`phases/`](./phases/index.md).
...
See [`docs/current/next-work.md`](../current/next-work.md). The phase files preserve detailed old context; `current/*` is the short source of truth for present state.
