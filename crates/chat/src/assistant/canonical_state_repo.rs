...
use super::{
    ConstraintContracts, EffectiveConstraints, FactObservation, OriginalIntent,
...
impl From<super::MergeError> for CanonicalStateRepositoryError {
    fn from(value: super::MergeError) -> Self {
        Self::Merge(value)
    }
}
